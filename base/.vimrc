...
"Conlict with COC enter to confirm selection
...
au FileType go  setlocal ts=2 sts=2 sw=2 expandtab
...
let g:coc_global_extensions = ['coc-tsserver', 'coc-golines', 'coc-css', 'coc-go', 'coc-json', 'coc-git', 'coc-solargraph']
